---
title: CommandKey
description: A simple command palette for React.
template: splash
hero:
  tagline: A simple command menu for React.<br/><b>✨ Press Ctrl + K</b>
  image:
    {
      html:
...
_Ensure you have [Tailwind CSS](https://tailwindcss.com) installed. Check the [docs](/docs) for more information_
```tsx
